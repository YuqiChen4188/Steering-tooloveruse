...
if __name__ == '__main__':
    ...
    data_path = f"/data/yuqi/SteeringMark/inference_results_qrsubspace/llama8b_/domain_intention_heading_askuser_qrsubspace_layer16_scale1p0_all.json"
    ...
    for data in answered_data:
        ...
        summary_results = data.get('summary_results', [])
    ...
    print(f"Missing Level 3 Recovery: {safe_percent(missing_lv3_recovers)}")
    print(f"Missing Level 2 Recovery: {safe_percent(missing_lv2_recovers)}")
    print(f"Missing Level 1 Recovery: {safe_percent(missing_lv1_recovers)}")
    print(f"Summary Success: {safe_percent(summary_successes)}")
