#!/usr/bin/env python3
"""Run tool-prompt inference with gated activation steering."""
...
def compute_progressive_suppression_scale(
    score: float,
    low_threshold: float,
    ...
    1. similarity/probability of tool use
    2. number of tools already used in the current trajectory
    """
    ...
    # Make later tool calls progressively harder: each previous tool call
    # increases suppression by 25%, capped at 2x the base scale.
    tool_count_factor = min(1.0 + 0.25 * prior_tool_calls, 2.0)
            ...
            while True:
                try:
                    ...
                    if gating_mode == "probe":
                        ...
                        steering_scale, similarity_factor, tool_count_factor = compute_progressive_suppression_scale(
